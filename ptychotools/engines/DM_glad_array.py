# -*- coding: utf-8 -*-
"""
Difference Map reconstruction engine that uses GLAD array-based library.
...
from glad.array_based import constraints as con, data_utils as du
from glad.array_based import FLOAT_TYPE
import numpy as np

#from memory_profiler import profile
__all__ = ['DM_glad_array']
...
def difference_map_iterator(diffraction, obj, object_weights, cfact_object, mask, probe, cfact_probe, probe_support,
    ...
    for it in range(num_iterations):
        ...
        errors[it] = con.difference_map_fourier_constraint(mask,
                                                           diffraction,
                                                           obj,
                                                           probe,
                                                           exit_wave,
        ...
        con.difference_map_overlap_update(addr,
                                          cfact_object,
                                          cfact_probe,
                                          do_update_probe,
                                          exit_wave,
...
class DM_glad_array(DM):
    ...
    def __init__(self, ptycho_parent, pars=None):
        ...
        """
        super(DM_glad_array, self).__init__(ptycho_parent, pars)
    ...
    def engine_prepare(self):
        ...
        """
        super(DM_glad_array, self).engine_prepare()
    ...
    def engine_iterate(self, num=1):
        ...
        for dID, _diffs in self.di.S.items():
            ...
            probe_support = self._probe_support[self.vectorised_scan[dID]['meta']['poe_IDs'][0]]
